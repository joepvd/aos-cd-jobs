...
pipeline {
    ...
    parameters {
        string(
            name: "VERSION",
            description: "Desired version name. Example: 3.0.1",
            defaultValue: "",
            trim: true,
        )
        string(
            name: "FROM_VERSION",
            description: "The build version to get the artifacts from. e.g. 3.5.0-6 from: http://download.eng.bos.redhat.com/staging-cds/developer/helm/3.5.0-6/signed/macos/",
            defaultValue: "",
            trim: true,
        )
    }
